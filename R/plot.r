...
Y = x$data
plot(as.data.frame(as.matrix(Y) %*% x$V[,1:2]),col=max.col(x$P),main='Estimate Latente of Space',xlab='Discriminative axis 1',ylab='Discriminative axis 2',pch= max.col(x$P))
if (loglik){ x11()
